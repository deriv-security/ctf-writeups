...
<head>
    ...
    <meta name="description" content="Login to UTOPIA Smart City Accommodation Finder">
...
<body>
    <div class="hero">
        <div class="container">
            <h1>UTOPIA</h1>
            <p class="hero-subtitle">Smart City Accommodation Finder</p>
        </div>
    </div>
            ...
            <div style="display: grid; gap: 1rem;">
                <div style="padding: 1rem; background: var(--white); border-radius: var(--radius-md); border: 1px solid var(--gray-200);">
                    ...
                    <div style="font-size: 0.875rem; color: var(--gray-600);">
                        ...
                        Password: <code style="background: var(--gray-100); padding: 0.125rem 0.5rem; border-radius: 0.25rem;">guest</code>
                    </div>
                </div>
            </div>
        </div>
